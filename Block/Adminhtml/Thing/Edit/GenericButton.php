<?php
namespace SomethingDigital\HelloUiComponents\Block\Adminhtml\Thing\Edit;
...
class GenericButton
{
    ...
    {
        return $this->context->getRequest()->getParam('somethingdigital_hellouicomponents_thing_id');
    }     
}
